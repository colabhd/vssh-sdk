...
Sete módulos, cada um importado por si:
...
`VSSH_APP_SOCKET`, `VSSH_APP_TOKEN`, `VSSH_APP_DATA_DIR`, `HOME`), e cada função que lê o
ambiente aceita `env` para que uma bancada meça sem mexer no processo.
...
__all__ = ['app', 'avisos', 'dados', 'eventos', 'gpu', 'servidor', 'web']
